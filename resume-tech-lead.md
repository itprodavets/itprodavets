...
- Drove adoption of an AI/RAG pipeline for automated incident reporting
- Delivered a telemetry system on PostgreSQL + TimescaleDB handling millions of data points
...
### Developer — Blueberry Consultants (Contract) / EMG / DEPO Computers / Himoil LLC | 2008 – 2020

*Detailed projects → [Blueberry (Remedi, GEMS)](./projects.en.md#blueberry) · [EMG (Web Expenses, ITpedia, HelpDesk)](./projects.en.md#emg) · [Himoil (ХиМ)](./projects.en.md#himoil) · [Earlier roles (DEPO)](./projects.en.md#earlier-roles)*

Full-stack development of enterprise SaaS, budget planning systems, helpdesk applications, reporting tools, and business process automation on the C#/.NET/MSSQL stack. Includes a short UK contract (Blueberry Consultants, Dec 2019 – Feb 2020) on two healthcare and recruitment CRMs.
