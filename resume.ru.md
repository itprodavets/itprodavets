...
### Ведущий программист - Microsoft (март 2022 – настоящее время)
...
### Ведущий программист - Huawei (сентябрь 2019 – март 2022)
...
- **Языки программирования:** Transact-SQL
- **Базы данных:** MSSQL
...
- **Языки программирования:** C#, Transact-SQL
- **Бэкенд-разработка:** ADO.NET, .NET
- **Базы данных:** MSSQL
